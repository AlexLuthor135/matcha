...
func (h *Handler) ResetPassword(w http.ResponseWriter, r *http.Request) {
	...
	switch {
	case errors.Is(err, AccountErrors.PasswordResetFieldsMissing),
		errors.Is(err, AccountErrors.InvalidPassword),
		errors.Is(err, AccountErrors.InvalidPasswordResetToken):
