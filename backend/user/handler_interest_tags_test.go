...
func TestProfileHandlersRejectUnsupportedInterestTag(t *testing.T) {
	tests := []struct {
		...
		handle  func(*UserHandler, http.ResponseWriter, *http.Request)
	}{
		{
			...
			handle: func(handler *UserHandler, response http.ResponseWriter, request *http.Request) {
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			...
			wantBody := UserErrors.InvalidInterestTag.Error() + "\n"
